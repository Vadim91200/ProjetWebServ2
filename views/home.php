    ...
    <div class="banner-wthree-info container">
        <div class="row">
            <div class="col-lg-5 banner-left-info">
                <h3>Le plus grand choix <span>de sac à main</span></h3>
                <a href="index.php?controller=shop" class="btn shop">Acheter maintenant</a>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-4 ab-content text-center p-lg-5 p-3 my-lg-5">
                ...
                <a href="index.php?controller=shop" class="btn shop mt-3">Shop Now</a>
